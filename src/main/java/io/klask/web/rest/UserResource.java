...
import io.klask.domain.Authority;
import io.klask.domain.User;
import io.klask.repository.AuthorityRepository;
import io.klask.repository.UserRepository;
import io.klask.repository.search.UserSearchRepository;
import io.klask.security.AuthoritiesConstants;
import io.klask.service.MailService;
import io.klask.service.UserService;
import io.klask.web.rest.dto.ManagedUserDTO;
...
public class UserResource {
    ...
    public ResponseEntity<?> createUser(@RequestBody ManagedUserDTO managedUserDTO, HttpServletRequest request) throws URISyntaxException {
        ...
        if (userRepository.findOneByLogin(managedUserDTO.getLogin().toLowerCase()).isPresent()) {
            ...
            mailService.createCreationMessage(newUser, baseUrl);
